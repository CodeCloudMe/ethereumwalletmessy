...
function preSendTransaction() {
    sendTransaction($("#tasignedtx").val(), function(e) {
        $("#txsendstatus").html('<p class="text-center text-success"><strong> Transaction submitted. TX ID: ' + e + "</strong></p>"), setWalletBalance()
    }, function(e) {
...
function preCreateTransaction() {
    try {
        ...
        var e = $("#sendtxaddress").val();
        if (64 != PrivKey.length) throw "Invalid Private key, try again";
        ...
        $("#txcreatestatus").html('<p class="text-center text-danger"><strong> ' + a + "</strong></p>").fadeIn(50).fadeOut(3e3), $("#divtransactionTAs").hide(), $("#divsendtranaction").hide()
    }
}
